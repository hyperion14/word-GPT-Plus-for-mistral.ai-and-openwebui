...
export const settingPreset = {
  api: {
    ...
    getFunc: () => localStorage.getItem(localStorageKey.api) || 'official',
    saveFunc: (value: string) => localStorage.setItem(localStorageKey.api, value),
  },
  localLanguage: {
    ...inputSetting('en'),
    type: 'select',
  ...
  mistralBaseURL: inputSetting('https://api.mistral.ai/v1'),
